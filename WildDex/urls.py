...
urlpatterns = [
    ...
    url(r'^new_user/$', views.get_reg_id, name='new_user'),
    url(r'^display_id/$', views.display_id, name='display_id'),
    url(r'^check_reg_id/$', views.check_reg_id, name='check_reg_id'),
    ...
    url(r'^view_animal_office/(?P<animal_id>\d+)$', views.view_animal_office, name='view_animal_office'),
    url(r'^branch_animal_table/$', views.branch_animal_table, name='branch_animal_table'),
    url(r'^office_animal_table/$', views.office_animal_table, name='office_animal_table'),
